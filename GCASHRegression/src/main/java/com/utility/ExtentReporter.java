...
import static com.utility.Utilities.getPlatform;
...
public class ExtentReporter implements ITestListener {
	...
	//	userType = context.getCurrentXmlTest().getParameter("userType");
		appVersion();
//		DeviceDetails.multiDeviceDetails(context.getCurrentXmlTest().getParameter("deviceName"));
...
//		Utilities.relaunch=true;
	...
	public synchronized void onFinish(ITestContext context) {
		...
		//extent.setSystemInfo("Device UDID - ", context.getCurrentXmlTest().getParameter("deviceName"));
		extent.flush();
