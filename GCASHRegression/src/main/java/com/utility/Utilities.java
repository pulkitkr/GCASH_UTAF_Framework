...
//			logger.error(e);
	...
	public static boolean verifyElementPresentAndClick(By byLocator, String validationtext) throws Exception {
		...
		try {
			...
			GCashBusinessLogic.softAssert.assertEquals(element.isDisplayed(), true,
					"" + validationtext + " " + " is displayed");
			logger.info("" + validationtext + " " + "is displayed");
			...
			GCashBusinessLogic.softAssert.assertEquals(false, true,
					"Element" + validationtext + " " + " is not visible");
...
//			System.out.println(e);
	...
	public void checkElementNotPresent(By byLocator) throws Exception {
		...
		try {
			...
			GCashBusinessLogic.softAssert.assertEquals(isElementNotPresent, false);
			logger.info("" + byLocator + " " + "is not displayed");
			ExtentReporter.extentLogger("checkElementNotPresent", "" + byLocator + "is not displayed");
		} catch (Exception e) {
			GCashBusinessLogic.softAssert.assertEquals(isElementNotPresent, true,
					"Element" + byLocator + " " + "is visible");
//			softAssert.assertAll();
	 ...
	 */
   /* @SuppressWarnings("rawtypes")
    public static void Swipe1(String direction, int count) {
    	String platform = Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getSuite().getName();
...
//			logger.error(e);
	...
	public void GetAndVerifyOrientation(String Value) throws Exception {
		...
		try {
			GCashBusinessLogic.softAssert.assertEquals(ScreenOrientation.equalsIgnoreCase(Value), true,
			...
			GCashBusinessLogic.softAssert.assertEquals(false, true,
					"The screen Orientation is not " + ScreenOrientation);
//			softAssert.assertAll();
...
//			logger.error(e);
	...
	public static void assertionValidation(String actual, String expected) throws Exception {
		...
		GCashBusinessLogic.softAssert.assertEquals(actual, expected);
	...
	public static void switchPlatformToAndroid() {
		waitTime(6000);
		Drivertools.setPlatfrom("Android");
	}
